...
%WHY CAN'T DO THIS? because we only want to calculate the error between 
%corresponding y and yPredict --> J = (1/m) .* sum(repmat(-y,1,num_labels) 
%.* log(h) - repmat((1-y),1,num_labels) .* log(1-h));
